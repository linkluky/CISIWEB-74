...
function processFood()
{
	...
	var toppings = 0; 
	var toppingBoxes = document.getElementsByName("toppings"); // error says "cannot read property 'length' of null at processFood" on line 51, but toppingBoxes is clearly defined here, yes? 9:35am
	...
	for (var i = 0; i < toppingBoxes.length; i++) // step 5d on page 530
	{
		...
		{
			toppings++;
			foodInfo["topping" + toppings] = toppingBoxes[i].value; // step 5d on page 530. Review p501 per Professor Sindt
			// okay, so this is attempting to use an associative array with the property name in square brackets, but what about the + toppings? Why that? Why isn't the script running yet? 11:34am 12/2
		}
	}
